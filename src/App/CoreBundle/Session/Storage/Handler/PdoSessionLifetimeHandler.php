...
namespace App\CoreBundle\Session\Storage\Handler;

use Symfony\Component\DependencyInjection\Container;
use Symfony\Component\HttpFoundation\Session\Storage\Handler\PdoSessionHandler;

class PdoSessionLifetimeHandler implements \SessionHandlerInterface {
    ...
    */
     ...
     */
    public function __construct(Container $container, $pdoOrDsn = null, array $options = array())
    {
    ...
    {
        $maxlifetime = $this->container->getParameter('session_pdo_lifetime');
