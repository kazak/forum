...
class OAuthUserProvider extends BaseOAuthUserProvider
{
    ...
    public function loadUserByOAuthUserResponse(UserResponseInterface $response)
    {
        ...
        if (null === $user) {
            ...
            $user->setUsername($fb_data['name']);
            $user->setEmail($fb_data['email']);
            $user->setFirstName($fb_data['first_name']);
            $user->setLastName($fb_data['last_name']);
