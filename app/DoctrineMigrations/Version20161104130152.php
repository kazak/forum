 ...
 */
class Version20161104130152 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE mail ADD CONSTRAINT FK_5126AC48CF60E67C FOREIGN KEY (owner) REFERENCES user (id)');
        $this->addSql('ALTER TABLE mail ADD CONSTRAINT FK_5126AC485F004ACF FOREIGN KEY (sender) REFERENCES user (id)');
