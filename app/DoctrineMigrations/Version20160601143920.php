 ...
 */
class Version20160601143920 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE organize (id INT AUTO_INCREMENT NOT NULL, admin INT DEFAULT NULL, city INT DEFAULT NULL, background VARCHAR(255) DEFAULT NULL, visible SMALLINT DEFAULT NULL, slug VARCHAR(128) NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, image LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', lng VARCHAR(255) DEFAULT NULL, lat VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_D24AB957989D9B62 (slug), INDEX IDX_D24AB957880E0D76 (admin), INDEX IDX_D24AB9572D5B0234 (city), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_organize (id_user INT NOT NULL, id_organize INT NOT NULL, INDEX IDX_32C75D576B3CA4B (id_user), INDEX IDX_32C75D57829155C2 (id_organize), PRIMARY KEY(id_user, id_organize)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE forum_team ADD CONSTRAINT FK_70106C8880E0D76 FOREIGN KEY (admin) REFERENCES user (id)');
