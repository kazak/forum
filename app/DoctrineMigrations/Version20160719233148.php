 ...
 */
class Version20160719233148 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE transport ADD gallery LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE transport DROP gallery');
    }
}
